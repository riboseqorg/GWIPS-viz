...
var speciesTree = (function() {
    ...
    var cfg = { labelRightX: 350, <!-- changed let the tree go more to the right, matthias --> 
                labelStartY: 18,
                speciesLineOffsetX: 8,
                branchLength: 0, <!-- changed to 0 the horizontal - fron the tree dissapear, matthias -->
                halfTextHeight: 4,
                hubLineOffset: 100,
                labelLineHeight: 18,
                paddingRight: 5,
	...
	if (taxId===40674 || 7742 || 6960 || 6239 || 1000000001 || 2 || 1000000002 || 3193 || 10239){
	text.grouptitle = function() {}; 
	} else {
...
var rainbow = (function() {
    ...
    var stripeColors = ['#90c8e0' ]; <!-- changed, otherwise you end up with black background to the left, matthias --> 
